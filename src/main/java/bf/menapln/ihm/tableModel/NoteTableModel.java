 ...
 * @author coulibaly
 */
public class NoteTableModel extends ObjetModel{
    private FeuilleCompositionService service;
    public NoteTableModel(List<Objet> data, Fenetre f) throws SQLException {
        super(data, f);
        this.modelTitle = new String[]{"Présence","Anonymat","Note","Statut Sport"};
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch(columnIndex){
            ...
            case 3:
                return feuille.getCandidat().getSport();
            default:
                return null;
        }
    }
